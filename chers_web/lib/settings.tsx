...
export function ChersSettingsProvider(props: { children: ReactNode }) {
	...
	return (
		<ChersSettingsContext.Provider value={settings}>
			{props.children}
...
class LocalStorageAdjustmentsStore<T extends JsonSafeObject>
	implements AdjustmentsStore<T>
{
	save(settings: Partial<T>): void {
...
const ChersSettingsContext = createContext<
	AdjustableSettings<typeof ChersSettingsDefaults>
>({
